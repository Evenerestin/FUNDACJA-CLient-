  ...
  <div id="gratitudeView" class="view">
    ...
    <div class="content flex">
      <div class="header flexColumn">
        ...
        <div>
          <p>
            Dziękujemy wszystkim za każdą formę wsparcia – zarówno materialną, jak i duchową. To
            dzięki Wam możemy wierzyć w lepsze jutro dla Anetki i mieć nadzieję na lepszą
            przyszłość.
          </p>
          <p>
            Dziękujemy naszej rodzinie i przyjaciołom, którzy byli przy nas na każdym kroku, dając
            nam siłę i nadzieję. Wasza miłość i troska są bezcenne. Dzięki Wam czuliśmy, że nie
            jesteśmy sami .
          </p>
          <p>
...
<style src="./GratitudeView.scss"></style>
